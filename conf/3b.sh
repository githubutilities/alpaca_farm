...
export STEP3_OUTPUT_DIR="output_ppo_test_more"
...
STEP3_EXTRA_ARGS+=" --checkpoint_layer_name transformers.models.llama.modeling_llama.LlamaDecoderLayer,transformers.models.llama.modeling_llama.LlamaModel"
# 17.3G
#STEP3_EXTRA_ARGS+=" --wrap_layer_name transformers.models.llama.modeling_llama.LlamaDecoderLayer"
STEP3_EXTRA_ARGS+=" --wrap_layer_name torch.nn.Linear,transformers.models.llama.modeling_llama.LlamaAttention,transformers.models.llama.modeling_llama.LlamaDecoderLayer"
# 28G
...
#STEP3_EXTRA_ARGS+=" --use_pp"
#STEP3_EXTRA_ARGS+=" --gradient_checkpointing_offload"
