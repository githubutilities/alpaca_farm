...
export STEP2_OUTPUT_DIR=output_rw_`basename $STEP2_DATASET_NAME`_`basename $STEP2_MODEL_DIR`_pref_v2
...
export STEP3_OUTPUT_DIR=~/wfs/output_chatgpt_ppo/output_ppo_`basename $STEP3_DATASET_NAME`_act-`basename $STEP3_ACTOR_DIR`_crit-`basename $STEP3_CRITIC_DIR`_std22
...
#export STEP3_DS_EXTRA_ARGS+=" --use_scale_reward --scale_reward_std 7.5 --scale_reward_mean 5.06"
